...
1. Use any online QR code reader to read the QR code.<br>

> [!TIP]
> [ScanQR](https://scanqr.org/#scan)

2. We'll then create a python script to recreate a new image file.
...
3. Use any online QR code reader to read the QR code.<br>
4. Get the flag.
